...
export const env = {
  ...
  NEXT_PUBLIC_TENANT_TAX_ENABLED:
    getEnv("NEXT_PUBLIC_TENANT_TAX_ENABLED", "true") === "true",
  NEXT_PUBLIC_TENANT_TAX_NAME: getEnv("NEXT_PUBLIC_TENANT_TAX_NAME", "ITBMS"),
  NEXT_PUBLIC_TENANT_TAX_RATE: Number.parseFloat(
    getEnv("NEXT_PUBLIC_TENANT_TAX_RATE", "0.07")
  ),
  NEXT_PUBLIC_TENANT_TAX_DESCRIPTION: getEnv(
    "NEXT_PUBLIC_TENANT_TAX_DESCRIPTION",
