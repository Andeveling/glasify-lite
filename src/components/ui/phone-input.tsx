...
const InputComponent = React.memo(
	React.forwardRef<HTMLInputElement, InputComponentProps>(
		({ className, ...props }, ref) => (
			<input
				className={cn(
...
const FlagComponent = React.memo(
	({ country, countryName }: RPNInput.FlagProps) => {
		...
		return (
			<span className="mx-auto flex h-auto w-4 overflow-hidden bg-transparent">
		...
		return (
			<Popover>
				...
				<PopoverContent className="w-[300px] p-0">
					<Command className="border border-neutral-200 dark:border-neutral-800 dark:bg-neutral-950">
						<CommandList>
