...
const CalendarChevron: DayPickerComponents['Chevron'] = ({ className, orientation, ...props }) => {
  if (orientation === 'left') {
...
const CalendarRoot: DayPickerComponents['Root'] = ({ className, rootRef, ...props }) => (
  <div className={cn(className)} data-slot="calendar" ref={rootRef} {...props} />
);

const CalendarWeekNumber: DayPickerComponents['WeekNumber'] = ({ children, ...props }) => (
  <td {...props}>
...
function Calendar({
  ...
  const classNameOverrides = {
    ...
    [DAY_PICKER_CLASS_KEYS.rangeEnd]: cn('rounded-r-md bg-accent', defaultClassNames.range_end),
    [DAY_PICKER_CLASS_KEYS.rangeMiddle]: cn('rounded-none', defaultClassNames.range_middle),
    [DAY_PICKER_CLASS_KEYS.rangeStart]: cn('rounded-l-md bg-accent', defaultClassNames.range_start),
    ...
    [DAY_PICKER_CLASS_KEYS.weekNumberHeader]: cn('w-(--cell-size) select-none', defaultClassNames.week_number_header),
    weekday: cn(
