...
export function CartIndicator({ className, variant = 'default' }: CartIndicatorProps) {
  ...
  return (
    <Button asChild className={cn('relative', className)} size={isCompact ? 'icon' : 'default'} variant="ghost">
      <Link href="/cart">
