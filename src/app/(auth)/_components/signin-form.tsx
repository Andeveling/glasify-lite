    ...
    <InputGroup>
      ...
      <InputGroupAddon align="inline-end">
        <button
          ...
          type="button"
        >
          {isVisible ? <EyeOff data-icon="inline-end" /> : <Eye data-icon="inline-end" />}
        </button>
      </InputGroupAddon>
    </InputGroup>
  )
...
export default function SignInForm({ isLoading = false, error }: SignInFormProps) {
  ...
  return (
    <Card className="w-full sm:max-w-md">
      ...
      <CardContent>
        <form id="signin-form" onSubmit={form.handleSubmit(handleCredentialsSubmit)}>
          <FieldGroup>
            ...
            <Field data-invalid={!!form.formState.errors.password}>
              ...
              <PasswordInput control={form.control} disabled={isSubmitDisabled} />
          ...
          {(form.formState.errors.root || error) && (
            <Alert className="mt-4" variant="destructive">
              <AlertDescription>{form.formState.errors.root?.message || error}</AlertDescription>
            </Alert>
          )}
        </form>
      </CardContent>
      <CardFooter>
        <Button className="w-full" disabled={isSubmitDisabled} form="signin-form" type="submit">
