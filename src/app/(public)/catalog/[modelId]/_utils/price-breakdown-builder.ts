 ...
 */
function addModelPriceItems(items: PriceBreakdownItem[], modelOnlyPrice: number) {
  if (modelOnlyPrice > 0) {
    items.push({
 ...
 */
function addAccessoriesPriceItem(items: PriceBreakdownItem[], accPrice: number) {
  if (accPrice > 0) {
    items.push({
      amount: accPrice,
      category: 'model',
 ...
 */
function addColorSurchargeItem(items: PriceBreakdownItem[], breakdown: PriceItemCalculationResult) {
 ...
 */
function addAdjustmentItems(items: PriceBreakdownItem[], breakdown: PriceItemCalculationResult) {
