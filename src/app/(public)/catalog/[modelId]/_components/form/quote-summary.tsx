    ...
    if (error || hasFormErrors) {
      return (
        <div className="flex flex-col gap-1">
          ...
          <span className="text-muted-foreground text-xs">Revisa los errores a continuación</span>
        </div>
      )
    }
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 text-4xl">{priceDisplay}</div>
          </div>
          <Button
          ...
          <div className="rounded-lg border border-(--color-warning)/20 bg-(--color-warning)/10 p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-(--color-warning-foreground)/80 text-sm">{error}</p>
              </div>
            </div>
          </div>
        )}
