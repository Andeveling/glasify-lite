    ...
    return (
      <div className="container mx-auto space-y-6 py-8">
        ...
        <div className="space-y-2">
          <h1 className="font-bold text-3xl tracking-tight">Colores del Modelo</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Estado actual de la configuración de colores</CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            ...
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">Colores disponibles para asignar:</span>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
            <div className="space-y-1">
              ...
              <CardDescription>
                Gestiona los colores disponibles para este modelo con sus respectivos recargos
              </CardDescription>
            </div>
            <AddColorDialog
        ...
        <Card className="border-muted-foreground/20">
          <CardHeader>
            <CardTitle className="text-base">💡 Información sobre Colores</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 text-muted-foreground text-sm">
            <ul className="list-inside list-disc space-y-1">
              <li>
                El <strong>recargo porcentual</strong> se aplica únicamente al precio base del
                modelo
              </li>
              <li>
                El <strong>color por defecto</strong> se selecciona automáticamente en nuevas
                cotizaciones
              </li>
              <li>
                Solo puede haber <strong>un color por defecto</strong> por modelo
              </li>
              <li>Los cambios de recargo se guardan automáticamente después de 500ms</li>
