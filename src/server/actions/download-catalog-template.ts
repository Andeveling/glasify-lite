...
export async function downloadCatalogTemplate() {
	...
	modelsSheet.columns = [
		...
		{
			header: "Descuento Vidrio Ancho (mm)",
			key: "glassDiscountWidthMm",
			width: 28,
		},
		{
			header: "Descuento Vidrio Alto (mm)",
			key: "glassDiscountHeightMm",
			width: 28,
		},
	...
	instructionsSheet.columns = [
		{ header: "Guía de Llenado", key: "content", width: 100 },
	];
	...
	instructionsSheet.getRow(TITLE_ROW).font = {
		bold: true,
	...
	instructionsSheet.addRow({
		content:
			'- Nombre: Nombre descriptivo del modelo (ej: "Ventana Corredera 2 Paños", "Puerta Abatible")',
	});
	instructionsSheet.addRow({
		content:
			'- Proveedor de Perfiles: Nombre del fabricante de perfiles (ej: "Rehau", "Vitro Rojas S.A.")',
	});
	instructionsSheet.addRow({
	...
	instructionsSheet.addRow({
		content:
			"- Precio Base: Costo del kit completo de perfiles (en la moneda local)",
	});
	instructionsSheet.addRow({
		content:
			"- Costo por mm: Precio adicional por cada milímetro de ancho/alto (puede ser 0)",
	});
	instructionsSheet.addRow({
		content:
			"- Descuento Vidrio: Milímetros a descontar del tamaño total para calcular área de vidrio",
	});
	instructionsSheet.addRow({
		content:
			"  Ejemplo: Si ventana es 1000mm y descuento es -7mm, el vidrio será 993mm",
	});
	instructionsSheet.addRow({ content: "" });
	...
	instructionsSheet.addRow({
		content:
			'- Nombre: Tipo y grosor del vidrio (ej: "Vidrio Claro 6mm", "Laminado 8mm", "Reflectivo Bronce 6mm")',
	});
	instructionsSheet.addRow({
		content:
			'- Proveedor: Fabricante del vidrio (ej: "Guardian", "Saint-Gobain", "Vitro")',
	});
	instructionsSheet.addRow({
	...
	instructionsSheet.addRow({
		content:
			"- Valor U: Transmitancia térmica (opcional, para vidrios con aislamiento)",
	});
	instructionsSheet.addRow({ content: "" });
	...
	instructionsSheet.addRow({
		content:
			'- Nombre: Nombre del servicio (ej: "Instalación", "Templado", "Transporte")',
	});
	instructionsSheet.addRow({
	...
	instructionsSheet.getRow(IMPORTANT_NOTES_ROW).font = {
		bold: true,
		color: { argb: "FFDC2626" },
	};
	instructionsSheet.addRow({
		content:
			"1. Las filas con ejemplos son SOLO de referencia. Reemplázalas con tus datos reales.",
	});
	instructionsSheet.addRow({
	...
	instructionsSheet.addRow({
		content:
			"3. Los precios deben estar en tu moneda local (sin símbolos, solo números).",
	});
	instructionsSheet.addRow({
		content:
			"4. Para descuentos de vidrio, usa números negativos (ej: -7, -66).",
	});
	instructionsSheet.addRow({
		content:
			"5. Una vez completado, envía este archivo de vuelta a tu contacto de Glasify.",
	});
