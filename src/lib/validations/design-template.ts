...
export const designTemplateCreateSchema = designTemplateBaseSchema

export const designTemplateUpdateSchema = designTemplateBaseSchema.partial()
...
export const designTemplateListSchema = z.object({
  ...
  sortBy: z.enum(["name", "pattern", "createdAt"]).default("name"),
...
export type DesignTemplateListInput = z.input<typeof designTemplateListSchema>
