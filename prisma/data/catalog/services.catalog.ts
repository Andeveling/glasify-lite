...
export const serviceBundles = {
	aluminumFinishing: [
		...
		"Película de Control Solar/UV",
	],
	maintenance: [
		"Ajuste y Mantenimiento de Herrajes",
		"Reemplazo de Sellos de Goma (EPDM)",
	],
	newInstallationBasic: [
	...
	securityUpgrade: [
		"Película de Seguridad Anti-Impacto",
		"Reja de Seguridad Exterior",
	],
};
