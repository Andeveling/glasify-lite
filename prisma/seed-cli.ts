...
import { vidriosLaEquidadColombiaPreset } from './data/presets/cristales-la-equidad-colombia.preset';
...
const PRESETS: Record<string, SeedPreset> = {
  ...
  'cristales-la-equidad-colombia': vidriosLaEquidadColombiaPreset,
