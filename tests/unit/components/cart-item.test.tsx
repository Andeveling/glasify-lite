...
describe("CartItem Component", () => {
  describe("Rendering", () => {
    ...
    it("should render pricing correctly", () => {
      ...
      expect(
        screen.getByText("Precio unitario: USD $15000.50")
      ).toBeInTheDocument();
    ...
    it("should use default currency (MXN) when not provided", () => {
      ...
      expect(
        screen.getByText("Precio unitario: MXN $15000.50")
      ).toBeInTheDocument();
    });

    it("should render without optional solution", () => {
      const itemWithoutSolution = {
        ...mockCartItem,
  ...
  describe("Quantity Adjustment", () => {
    it("should call onUpdateQuantity when + button is clicked", async () => {
      ...
      render(
        <CartItem item={mockCartItem} onUpdateQuantity={mockUpdateQuantity} />
      );
    ...
    it("should not call onUpdateQuantity if would exceed max (100)", async () => {
      ...
      render(
        <CartItem item={itemAtMax} onUpdateQuantity={mockUpdateQuantity} />
      );
    ...
    it("should not call onUpdateQuantity if would go below min (1)", async () => {
      ...
      render(
        <CartItem item={itemAtMin} onUpdateQuantity={mockUpdateQuantity} />
      );
  ...
  describe("Accessibility", () => {
    it("should have accessible quantity controls", () => {
      ...
      expect(
        screen.getByRole("group", { name: "Controles de cantidad" })
      ).toBeInTheDocument();
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle zero unit price", () => {
      ...
      expect(
        screen.getByText("Precio unitario: MXN $0.00")
      ).toBeInTheDocument();
    ...
    it("should handle fractional prices correctly", () => {
      ...
      expect(
        screen.getByText("Precio unitario: MXN $1234.57")
      ).toBeInTheDocument();
