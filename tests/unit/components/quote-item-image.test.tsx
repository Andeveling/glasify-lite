...
describe('QuoteItemImage', () => {
  ...
  describe('SVG Diagram Fallback', () => {
    it('should render WindowDiagram when modelImageUrl is null', () => {
      render(<QuoteItemImage {...defaultProps} modelImageUrl={null} />);
    ...
    it('should render WindowDiagram when modelImageUrl is empty string', () => {
      render(<QuoteItemImage {...defaultProps} modelImageUrl="" />);
    ...
    it('should pass windowType to WindowDiagram fallback', () => {
      render(<QuoteItemImage {...defaultProps} modelImageUrl={null} windowType={WindowType.FRENCH_2_PANEL} />);
    ...
    it('should pass size to WindowDiagram fallback', () => {
      render(<QuoteItemImage {...defaultProps} modelImageUrl={null} size="lg" />);
    ...
    it('should use DEFAULT_WINDOW_TYPE when windowType is UNKNOWN', () => {
      render(<QuoteItemImage {...defaultProps} modelImageUrl={null} windowType={WindowType.UNKNOWN} />);
  ...
  describe('Click Interaction (Lightbox)', () => {
    it('should call onClick when image is clicked', async () => {
      ...
      render(<QuoteItemImage {...defaultProps} onClick={handleClick} />);
    ...
    it('should call onClick when WindowDiagram is clicked', async () => {
      ...
      render(<QuoteItemImage {...defaultProps} modelImageUrl={null} onClick={handleClick} />);
  ...
  describe('Accessibility', () => {
    ...
    it('should have alt text in Spanish for SVG diagrams', () => {
      render(<QuoteItemImage {...defaultProps} modelImageUrl={null} windowType={WindowType.AWNING} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing windowType gracefully', () => {
      render(
        <QuoteItemImage modelImageUrl={null} modelName="Test Product" windowType={undefined as unknown as WindowType} />
      );
    ...
    it('should render without crashing when all props are minimal', () => {
      render(<QuoteItemImage modelImageUrl={null} modelName="" windowType={WindowType.UNKNOWN} />);
