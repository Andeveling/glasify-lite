...
describe('QuoteExcelWorkbook', () => {
  it('should have createQuoteExcelWorkbook function available', () => {
    ...
    expect(() => {
      const { createQuoteExcelWorkbook } = require('../../../src/lib/export/excel/quote-excel-workbook');
  ...
  it('should export writeQuoteExcel function', () => {
    expect(() => {
      const { writeQuoteExcel } = require('../../../src/lib/export/excel/quote-excel-workbook');
