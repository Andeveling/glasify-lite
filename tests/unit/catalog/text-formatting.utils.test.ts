...
describe('formatNumber', () => {
  it('should format numbers with thousand separators (es-AR)', () => {
    ...
    expect(formatNumber(ONE_MILLION_TWO_HUNDRED_THIRTY_FOUR_THOUSAND)).toBe('1.234.567');
  });
...
describe('formatResultCount', () => {
  ...
  describe('multiple results', () => {
    ...
    it('should return plural form with thousand separators', () => {
      ...
      expect(formatResultCount(ONE_THOUSAND_TWO_HUNDRED_THIRTY_FOUR)).toBe('1.234 modelos encontrados');
      expect(formatResultCount(ONE_MILLION_TWO_HUNDRED_THIRTY_FOUR_THOUSAND)).toBe('1.234.567 modelos encontrados');
    });
  });
  ...
  describe('edge cases', () => {
    it('should handle large numbers', () => {
      expect(formatResultCount(NINE_HUNDRED_NINETY_NINE_THOUSAND)).toBe('999.999 modelos encontrados');
    });
