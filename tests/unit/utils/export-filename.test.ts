...
describe('generateExportFilename', () => {
  ...
  it('should truncate long project names', () => {
    const projectName = 'Este es un nombre de proyecto extremadamente largo que debería ser truncado';
    const date = new Date('2025-10-12');
    const format = 'pdf';
  ...
  it('should handle accented characters', () => {
    ...
    expect(filename).toMatch(/Cotizacion_Residencial_Jos[eé]_Mar[ií]a_2025-10-12\.pdf/);
  });
