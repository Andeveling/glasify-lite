...
- What happens when user tries to delete a supplier with related glass types? → Show error toast explaining referential integrity constraint: "No se puede eliminar este proveedor porque tiene tipos de vidrio asociados. Primero elimina o reasigna los tipos de vidrio.", keep supplier in list
