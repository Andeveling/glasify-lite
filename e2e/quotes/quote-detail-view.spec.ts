...
test.describe("Quote Detail View", () => {
  ...
  test("should display complete quote information", async ({ page }) => {
    ...
    await expect(
      page.getByRole("columnheader", { name: /nombre/i })
    ).toBeVisible();
    await expect(
      page.getByRole("columnheader", { name: /modelo/i })
    ).toBeVisible();
    await expect(
      page.getByRole("columnheader", { name: /tipo de vidrio/i })
    ).toBeVisible();
    await expect(
      page.getByRole("columnheader", { name: /dimensiones/i })
    ).toBeVisible();
    await expect(
      page.getByRole("columnheader", { name: /cantidad/i })
    ).toBeVisible();
    await expect(
      page.getByRole("columnheader", { name: /precio unitario/i })
    ).toBeVisible();
    await expect(
      page.getByRole("columnheader", { name: /subtotal/i })
    ).toBeVisible();
  ...
  test("should display optional contact phone when present", async ({
    page,
  }) => {
  ...
  test("should handle unauthorized access to other user quote", async ({
    page,
  }) => {
  ...
  test("should display items with correct dimensions format", async ({
    page,
  }) => {
    await page.goto("/quotes");
    await page
  ...
  test("should show solution name or dash for items without solution", async ({
    page,
  }) => {
    await page.goto("/quotes");
    await page
    ...
    const solutionCells = page
      .getByRole("table")
      .getByRole("row")
      .locator("td:nth-child(4)"); // Solution column
