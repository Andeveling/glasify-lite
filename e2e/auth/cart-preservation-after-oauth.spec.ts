...
test.describe("Cart Preservation After OAuth", () => {
  test("should preserve all cart item properties after auth redirect", async ({
    page,
  }) => {
    ...
    const initialItemName = await page
      .locator('[data-testid="cart-item-name"]')
      .first()
      .textContent();
    const initialWidth = await page
      .locator('[data-testid="cart-item-width"]')
      .first()
      .textContent();
    const initialHeight = await page
      .locator('[data-testid="cart-item-height"]')
      .first()
      .textContent();
    ...
    const finalItemName = await page
      .locator('[data-testid="cart-item-name"]')
      .first()
      .textContent();
    const finalWidth = await page
      .locator('[data-testid="cart-item-width"]')
      .first()
      .textContent();
  ...
  test("should preserve custom item names after auth redirect", async ({
    page,
  }) => {
    ...
    const nameInput = page
      .locator('[data-testid="cart-item-name-input"]')
      .first();
    ...
    const preservedName = await page
      .locator('[data-testid="cart-item-name-input"]')
      .first()
      .inputValue();
  ...
  test("should preserve edited quantities after auth redirect", async ({
    page,
  }) => {
    ...
    const preservedQuantity = await page
      .locator('[data-testid="cart-item-quantity"]')
      .first()
      .inputValue();
  ...
  test("should preserve empty cart state after auth redirect", async ({
    page,
  }) => {
  ...
  test("should handle sessionStorage across multiple auth redirects", async ({
    page,
  }) => {
